(ns sixsq.nuvla.server.resources.credential-service-azure
    "
...
(defmethod p/tpl->credential tpl/credential-type
           [{:keys [type method azure-subscription-id azure-client-secret azure-client-id services acl]} request]
