...
(deftest simple-spec-test
  ...
  (testing "clojure.specs"
    ...
    (is (= (t/transform ::keys)
           {:type       "object"
            :properties {"sixsq.nuvla.db.es.common.es-mapping-test/a" {:type "keyword"}
                         "sixsq.nuvla.db.es.common.es-mapping-test/b" {:type "keyword"}
    ...
    (is (= (t/transform (s/merge (s/keys :req [::integer])
                                 (s/keys :req [::string])))
           {:type       "object"
            :properties {"sixsq.nuvla.db.es.common.es-mapping-test/integer" {:type "long"}
                         "sixsq.nuvla.db.es.common.es-mapping-test/string"  {:type "keyword"}}}))
