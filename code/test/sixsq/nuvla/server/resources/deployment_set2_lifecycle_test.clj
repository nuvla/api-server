(ns sixsq.nuvla.server.resources.deployment-set2-lifecycle-test
  (:require
    ...
    [sixsq.nuvla.server.resources.deployment-set2 :as t]
...
(def valid-deployment-set {:name  "New dep set",
                           :start false,
                           :applications-sets
...
(def u-applications-sets-v11
  {:description               "mutli",
   ...
   :updated-by                "user/b9b4b6c4-61c4-406a-b5c5-e77703800131",
   :created-by                "user/b9b4b6c4-61c4-406a-b5c5-e77703800131",
   :id                        "module/ff0e0e39-4c22-411b-8c39-868aa50da1f5",
   :resource-type             "module",
   :acl
   {:edit-data ["group/nuvla-admin"],
    :owners    ["user/b9b4b6c4-61c4-406a-b5c5-e77703800131"],
...
(def u-deployment-set
  {:updated       "2023-04-12T12:35:00.564Z",
   ...
   :state         "CREATING",
   :created-by    "user/b9b4b6c4-61c4-406a-b5c5-e77703800131",
   :id            "deployment-set2/51e193db-8c21-4bf2-a5b2-852f6c22e20d",
   :resource-type "deployment-set2",
   :acl
   {:edit-data ["group/nuvla-admin"],
    :owners    ["user/b9b4b6c4-61c4-406a-b5c5-e77703800131"],
    :view-acl  ["group/nuvla-admin"],
   ...
   :operations
   [{:rel  "edit",
     :href "deployment-set2/51e193db-8c21-4bf2-a5b2-852f6c22e20d"}
    {:rel  "delete",
     :href "deployment-set2/51e193db-8c21-4bf2-a5b2-852f6c22e20d"}
    {:rel "create",
     :href
     "deployment-set2/51e193db-8c21-4bf2-a5b2-852f6c22e20d/create"}]})
