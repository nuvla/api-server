...
(deftest test-schema-check
  (let [timestamp "1964-08-25T10:00:00.00Z"
    ...
    (stu/is-valid ::t/schema (assoc-in root [:applications-sets 0 :applications 0 :environmental-variables]
                                       [{:name  "var_1"
                                         :value "var_1 value"}]))
    (stu/is-valid ::t/schema (assoc-in root [:applications-sets 0 :applications 0 :container-registries]
                                       [{:infrastructure-service "infrastructure-service/aa2f41a3-c54c-fce8-32d2-0324e1c32ee1"
                                         :credential             "credential/ba2f41a3-c54c-fce8-32d2-0324e1c32ee2"}]))
