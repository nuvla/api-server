(ns sixsq.nuvla.server.resources.spec.resource-metadata-value-scope-unit-test
  (:require
    [clojure.test :refer [deftest]]
    [sixsq.nuvla.server.resources.spec.resource-metadata-value-scope-unit :as spec]
