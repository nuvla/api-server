        ...
        (let [nuvlabox-id  (-> session
          ...
          (let [{isg-id :id} (-> session-admin
            ...
            (let [check-api        (-> session
              ...
              (action-post revoke-ssh-key "revoke-ssh-key" {:credential aux-ssh-cred} "revoked ssh key from nuvlabox")

              ;; update-nuvlabox-action
              (action-post update-nuvlabox "update-nuvlabox" {:nuvlabox-release nuvlabox-release} "updated nuvlabox"))
