...
(deftest lifecycle
  (let [session-anon (-> (ltu/ring-app)
        ...
        valid-subscription {:type         "notification"
                            ...
                            :notification (str "notification-config/" (str (UUID/randomUUID)))
    ...
    (let [user-uri      (-> session-user
      ...
      (let [notif-id (str "notification-config/" (str (UUID/randomUUID)))
            updated (assoc valid-subscription :notification notif-id)]
        ...
        (let [updated-body (-> session-admin
          ...
          (is (= notif-id (:notification updated-body)))))
