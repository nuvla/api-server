(ns com.sixsq.nuvla.server.resources.spec.credential-template-swarm-token-test
  (:require
    ...
    [com.sixsq.nuvla.server.resources.spec.credential-template-swarm-token :as swarm-token-spec]
