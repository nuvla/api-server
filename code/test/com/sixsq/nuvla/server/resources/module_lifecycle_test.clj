...
(deftest module-publish-creates-event-test
  (let [valid-application {:author         "someone"
    ...
    (module-publish-creates-event module-spec/subtype-app-docker valid-application)))
...
(deftest lifecycle-component
  (let [valid-component {:author        "someone"
                         ...
                         :ports         [{:protocol       "tcp"
                                          :target-port    22
                                          :published-port 8022}]}]
    (lifecycle-test-module module-spec/subtype-comp-docker valid-component)))
...
(deftest lifecycle-application
  (let [valid-application {:author         "someone"
    ...
    (lifecycle-test-module module-spec/subtype-app-docker valid-application)))
