(ns com.sixsq.nuvla.server.resources.credential-infrastructure-service-helm-repo-lifecycle-test
  (:require
    ...
    [com.sixsq.nuvla.server.resources.credential-template-infrastructure-service-helm-repo
...
(deftest check-metadata
  (mdtu/check-metadata-exists (str credential/resource-type "-" cred-tpl-helm-repo/resource-url)))
...
(deftest lifecycle
  (let [session               (-> (ltu/ring-app)
        ...
        href                  (str cred-tpl/resource-type "/" cred-tpl-helm-repo/method)
        template-url          (str p/service-context cred-tpl/resource-type "/" cred-tpl-helm-repo/method)
