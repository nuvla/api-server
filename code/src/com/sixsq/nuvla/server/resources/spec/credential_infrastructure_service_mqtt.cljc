(ns com.sixsq.nuvla.server.resources.spec.credential-infrastructure-service-mqtt
  (:require
    ...
    [com.sixsq.nuvla.server.resources.spec.credential-template-infrastructure-service-mqtt
     :as service]
