(ns com.sixsq.nuvla.server.resources.spec.credential-infrastructure-service-helm-repo
  (:require
    ...
    [com.sixsq.nuvla.server.resources.spec.credential-template-infrastructure-service-helm-repo :as service]
