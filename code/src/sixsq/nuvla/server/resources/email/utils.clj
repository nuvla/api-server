...
(defn email-data-trial-ending [trial-days-left resources url]
  (let [pre-texts  (conj [(format "Your Nuvla.io trial is will end in %d days. Now is a good time to upgrade and get all the awesome benefits." 
                                  trial-days-left)
               ...
               {:type    "text/html; charset=utf-8"
                :content (render-email
                           {:title          "Your Nuvla.io trial is ending"
                            :button-text    "Choose a Novla.io plan today:"
                            :button-url     url
                            :text-1        (str "<p>" 
                                                (str/join "</p><p>" 
                                                          (concat pre-texts 
