(ns sixsq.nuvla.server.resources.credential-gpg-key
  "
...
"
  (:require
    ...
    [sixsq.nuvla.server.resources.credential-template-gpg-key :as tpl]
    [sixsq.nuvla.server.resources.resource-metadata :as md]
    [sixsq.nuvla.server.resources.spec.credential-gpg-key :as gpg-key]
