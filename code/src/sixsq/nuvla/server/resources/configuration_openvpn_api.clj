(ns sixsq.nuvla.server.resources.configuration-openvpn-api
  (:require
...
(def create-validate-fn (u/create-spec-validation-fn ::cts-openvpn-api/schema-create))
...
(defn initialize
  []
  (std-crud/initialize p/resource-type ::cts-openvpn-api/schema))
