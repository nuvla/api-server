...
(s/def ::amount
  (-> (st/spec double)
      (assoc :name "amount"
             ...
             :json-schema/help "amount of the voucher"
...
(s/def ::currency
  (-> (st/spec ::cimi-core/nonblank-string)
      (assoc :name "currency"
             ...
             :json-schema/help "currency for the voucher amount"
             :json-schema/group "body"
...
(s/def ::expiration-date
  (-> (st/spec ::cimi-core/timestamp)
      (assoc :name "expiration-date"
             :json-schema/name "expiration-date"
             ...
             :json-schema/help "expiration-date for the voucher"
             :json-schema/group "body"
...
(s/def ::state
  (-> (st/spec #{"new", "activated",
      ...
      (assoc :name "state"
             ...
             :json-schema/help "usage state of the voucher"
             :json-schema/group "body"
...
(s/def ::service-info
  (-> (st/spec ::cimi-core/url)
      (assoc :name "service-info"
             ...
             :json-schema/help "URL for the service provider who issued the voucher"
             :json-schema/group "body"
...
(s/def ::activated
  (-> (st/spec ::cimi-core/timestamp)
      (assoc :name "activated"
             ...
             :json-schema/help "when the voucher was activated"
             :json-schema/group "body"
...
(s/def ::redeemed
  (-> (st/spec ::cimi-core/timestamp)
      (assoc :name "redeemed"
             ...
             :json-schema/help "when the voucher was redeemed"
             :json-schema/group "body"
...
(s/def ::target-audience
  (-> (st/spec ::cimi-core/nonblank-string)
      (assoc :name "target-audience"
             :json-schema/name "target-audience"
             :json-schema/type "string"
             :json-schema/required true
             :json-schema/editable true
             ...
             :json-schema/help "who the voucher is targeted for"
             :json-schema/group "body"
...
(s/def ::batch-reference
  (-> (st/spec ::cimi-core/nonblank-string)
      (assoc :name "batch-reference"
             :json-schema/name "batch-reference"
             :json-schema/type "string"
             :json-schema/required false
             :json-schema/editable true
             ...
             :json-schema/help "reference for the batch this voucher belongs to"
             :json-schema/group "body"
...
(s/def ::wave-id
  (-> (st/spec ::cimi-core/nonblank-string)
      (assoc :name "wave-id"
             ...
             :json-schema/help "optional identifier for the wave when the voucher was issued"
             :json-schema/group "body"
