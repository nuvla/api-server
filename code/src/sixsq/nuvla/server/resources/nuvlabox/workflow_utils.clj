...
(defn commission
  ...
  (when-let [isg-id infrastructure-service-group]
    (let [swarm-id (or
                     (update-coe-service id name acl isg-id swarm-endpoint tags capabilities "swarm")
                     (create-coe-service id name acl isg-id swarm-endpoint tags capabilities "swarm"))
          kubernetes-id (or
                          (update-coe-service id name acl isg-id kubernetes-endpoint tags capabilities "kubernetes")
                          (create-coe-service id name acl isg-id kubernetes-endpoint tags capabilities "kubernetes"))
          minio-id (or
